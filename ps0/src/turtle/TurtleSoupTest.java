...
public class TurtleSoupTest {
    ...
    public void calculateHeadingsTest() {
        ...
        List<Integer> xSamplepoints = new ArrayList<>();
        List<Integer> ySamplepoints = new ArrayList<>();
        xSamplepoints.add(0);
        xSamplepoints.add(0);
        xSamplepoints.add(1);
        xSamplepoints.add(1);
        ...
        List<Double> resultSample = TurtleSoup.calculateHeadings(xSamplepoints, ySamplepoints);
        assertEquals(3, resultSample.size());
        assertEquals(180.0, resultSample.get(0), 0.001);
        assertEquals(270.0, resultSample.get(1), 0.001);
        assertEquals(270.0, resultSample.get(2), 0.001);
