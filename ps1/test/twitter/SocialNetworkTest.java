...
public class SocialNetworkTest {
    ...
    public void testGuessFollowsGraph() {     
        ...
        assertTrue("expected empty graph", followsGraphLowercase.isEmpty()||followsGraphLowercase.get(tweet1.getAuthor()).isEmpty());
        ...
        assertFalse("expected graph don't containhimeself",followsGraph3Lowercase.get(tweet5.getAuthor()).contains(tweet5.getAuthor()));
    ...
    public void testInfluencers() {
        ...
        assertTrue("expected top 2", influencers3.subList(0, 2).containsAll(Arrays.asList("ddr")));
