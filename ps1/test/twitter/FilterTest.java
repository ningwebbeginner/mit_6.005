...
public class FilterTest {
    ...
    public void testInTimespan() {
        ...
        List<Tweet> inTimespanAtStart = Filter.inTimespan(Arrays.asList(tweet3, tweet4, tweet5), new Timespan(testStart, testEnd));
        ...
        List<Tweet> inTimespan1 = Filter.inTimespan(Arrays.asList(tweet3, tweet4, tweet6), new Timespan(testStart, testEnd));
        ...
        List<Tweet> inTimespan2 = Filter.inTimespan(Arrays.asList(tweet3, tweet6, tweet7), new Timespan(testStart, testEnd));
    ...
    public void testContaining() {
        ...
        List<Tweet> containingTwoTimes = Filter.containing(Arrays.asList(tweet1, tweet2, tweet3), Arrays.asList("talk"));
        
        assertEquals("expected same order", 3, containingTwoTimes.size());
        assertTrue("expected list to contain tweets", containingTwoTimes.containsAll(Arrays.asList(tweet1, tweet2, tweet3)));
        ...
        List<Tweet> containingEndOfString = Filter.containing(Arrays.asList(tweet1, tweet2, tweet3), Arrays.asList("much"));
        ...
        // test two words
        List<Tweet> containingTwoWord = Filter.containing(Arrays.asList(tweet1, tweet2, tweet3), Arrays.asList("talk", "much"));
